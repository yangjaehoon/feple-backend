...
public class AdminAccountController {
    ...
    public String create(@RequestParam String username,
        ...
        AdminActionUtils.tryAction(
                () -> {
                    adminLogService.log(AdminAction.ADMIN_ACCOUNT_CREATE, null, null, username);
    ...
    public String update(@PathVariable Long id,
        ...
        AdminActionUtils.tryAction(
                () -> {
                    adminLogService.log(AdminAction.ADMIN_ACCOUNT_UPDATE, null, id, displayName);
    ...
    public String delete(@PathVariable Long id,
        ...
        AdminActionUtils.tryAction(
                () -> {
                    adminLogService.log(AdminAction.ADMIN_ACCOUNT_DELETE, null, id, null);
    ...
    public String toggleEnabled(@PathVariable Long id,
        ...
        AdminActionUtils.tryAction(
                () -> {
                    adminLogService.log(AdminAction.ADMIN_ACCOUNT_TOGGLE, null, id, null);
